...
public class BusinessNewsAdapter extends RecyclerView.Adapter<BusinessNewsAdapter.NewsHolder>{
    ...
    public BusinessNewsAdapter(Application application){
        this.application = application;
    }
    public BusinessNewsAdapter(){
    }
    @NonNull
    @Override
    ...
    public void onBindViewHolder(@NonNull NewsHolder holder, int position) {
        ...
        holder.btnFav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                news.setId(position+list.size()*3);

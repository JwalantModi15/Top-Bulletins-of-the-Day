...
public class EntertainmentNewsAdapter extends RecyclerView.Adapter<EntertainmentNewsAdapter.NewsHolder>{
    ...
    public EntertainmentNewsAdapter(Application application){
        this.application = application;
    }
    public EntertainmentNewsAdapter(){
    }
    @NonNull
    @Override
    ...
    public void onBindViewHolder(@NonNull NewsHolder holder, int position) {
        ...
        holder.btnFav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                news.setId(position+list.size()*2);

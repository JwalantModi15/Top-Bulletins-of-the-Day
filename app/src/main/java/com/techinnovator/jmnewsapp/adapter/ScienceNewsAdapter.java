...
public class ScienceNewsAdapter extends RecyclerView.Adapter<ScienceNewsAdapter.NewsHolder>{
    ...
    public ScienceNewsAdapter(Application application){
        this.application = application;
    }
    public ScienceNewsAdapter(){
    }
    @NonNull
    @Override
    ...
    public void onBindViewHolder(@NonNull NewsHolder holder, int position) {
        ...
        holder.btnFav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                news.setId(position+list.size()*5);

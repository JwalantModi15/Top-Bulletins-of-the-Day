...
public class HealthNewsAdapter extends RecyclerView.Adapter<HealthNewsAdapter.NewsHolder>{
    ...
    public HealthNewsAdapter(Application application){
    ...
    public void onBindViewHolder(@NonNull NewsHolder holder, int position) {
        ...
        holder.btnFav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                news.setId(position+list.size()*4);

...
public class TechnologyNewsAdapter extends RecyclerView.Adapter<TechnologyNewsAdapter.NewsHolder>{
    ...
    public TechnologyNewsAdapter(Application application){
        this.application = application;
    }
    public TechnologyNewsAdapter(){
    }
    @NonNull
    @Override
